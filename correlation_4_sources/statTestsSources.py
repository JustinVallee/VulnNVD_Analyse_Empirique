...
dfContingTableSecureworksGraynoise = pd.crosstab(df['secureworks'], df['graynoise_reports_count'])
dfContingTableClamGraynoise = pd.crosstab(df['clam'], df['graynoise_reports_count'])
dfContingTableCisaGraynoise = pd.crosstab(df['cisa'], df['graynoise_reports_count'])


#!!!Select the right Contingency Table to use!!!
dfContingencyTable = dfContingTableSecureworksCisa
